...
class CoDeepNEATModuleConv2DMaxPool2DDropoutDense(CoDeepNEATModuleBase):
    """
    ...
    def __str__(self) -> str:
        ...
        """
        return "CoDeepNEAT Conv2D MaxPool Dropout Module | ID: {:>6} | Fitness: {:>6} | Units: {:>4} | Filters: {:>4} | " \
    ...
    def create_mutation(self,
                        offspring_id,
                        max_degree_of_mutation) -> CoDeepNEATModuleConv2DMaxPool2DDropoutDense:
        """
        ...
        return CoDeepNEATModuleConv2DMaxPool2DDropoutDense(config_params=self.config_params,
    ...
    def get_module_type(self) -> str:
        """"""
        return 'Conv2DMaxPool2DDropoutDense'
